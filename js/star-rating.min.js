...
$( document ).ready(function() {
    ...
    $ninth = 1654;
    $tenth = 1445;
    $('#first-rate-show').html("Rate it! (" + $first + ")");
    $('#second-rate-show').html("Rate it! (" + $second + ")");
    $('#third-rate-show').html("Rate it! (" + $third + ")");
    $('#fourth-rate-show').html("Rate it! (" + $fourth + ")");
    $('#fifth-rate-show').html("Rate it! (" + $fifth + ")");
    $('#sixth-rate-show').html("Rate it! (" + $sixth + ")");
    $('#seventh-rate-show').html("Rate it! (" + $seventh + ")");
    $('#eights-rate-show').html("Rate it! (" + $eights + ")");
    $('#ninth-rate-show').html("Rate it! (" + $ninth + ")");
    $('#tenth-rate-show').html("Rate it! (" + $tenth + ")");
});

$('#first, #second, #third, #fourth, #fifth, #sixth, #seventh, #eights, #ninth, #tenth').rating({
    hoverEnabled: true,
    showCaption: false,
    showClear: false,
...
$('#first').on('rating.change', function() {
    $first += 1;
    $('#first-rate-show').html("Thank you! (" + $first +")");
    $('#first').rating("refresh", {
        readonly: true,
    });
});

$('#second').on('rating.change', function() {
    $second += 1;
    $('#second-rate-show').html("Thank you! (" + $second +")");
    $('#second').rating("refresh", {
        readonly: true,
    });
});

$('#third').on('rating.change', function() {
    $third += 1;
    $('#third-rate-show').html("Thank you! (" + $third +")");
    $('#third').rating("refresh", {
        readonly: true,
    });
});

$('#fourth').on('rating.change', function() {
    $fourth += 1;
    $('#fourth-rate-show').html("Thank you! (" + $fourth +")");
    $('#fourth').rating("refresh", {
        readonly: true,
    });
});

$('#fifth').on('rating.change', function() {
    $fifth += 1;
    $('#fifth-rate-show').html("Thank you! (" + $fifth +")");
    $('#fifth').rating("refresh", {
        readonly: true,
    });
});

$('#sixth').on('rating.change', function() {
    $sixth += 1;
    $('#sixth-rate-show').html("Thank you! (" + $sixth +")");
    $('#sixth').rating("refresh", {
        readonly: true,
    });
});

$('#seventh').on('rating.change', function() {
    $seventh += 1;
    $('#seventh-rate-show').html("Thank you! (" + $seventh +")");
    $('#seventh').rating("refresh", {
        readonly: true,
    });
});

$('#eights').on('rating.change', function() {
    $eights += 1;
    $('#eights-rate-show').html("Thank you! (" + $eights +")");
    $('#eights').rating("refresh", {
        readonly: true,
    });
});

$('#ninth').on('rating.change', function() {
    $ninth += 1;
    $('#ninth-rate-show').html("Thank you! (" + $ninth +")");
    $('#ninth').rating("refresh", {
        readonly: true,
    });
});

$('#tenth').on('rating.change', function() {
    $tenth += 1;
    $('#tenth-rate-show').html("Thank you! (" + $tenth +")");
    $('#tenth').rating("refresh", {
        readonly: true,
    });
});
